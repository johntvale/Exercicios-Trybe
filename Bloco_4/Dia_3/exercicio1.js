...
// criar uma variável "n" para receber o número de lados de um quadrado, e variável listaDeAsteriscos para criar um dos lados do quadrado.
let n=10;
let listaDeAsteriscos=[];

// criar um comando For para receber '*' na variavel 'listaDeAsteriscos'.
